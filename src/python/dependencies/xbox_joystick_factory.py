...
import platform
from dependencies.xbox_joystick import XboxJoystick

if platform.system() == "Windows":
    from dependencies.xbox_joystick_windows import XboxJoystickWindows
else:
    import distro
    from dependencies.xbox_joystick_linux import XboxJoystickLinux
